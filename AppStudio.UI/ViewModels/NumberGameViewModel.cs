...
{
    public class NumberGameViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "NumberGameDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new NumberGameDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("NumberGameDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("NumberGameDetail");
        }
    }
}
